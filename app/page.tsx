        ...
        <div className="flex items-center gap-4">
          {user ? (
            ...
            <>
              <Link 
                href="/dashboard" 
                className="text-[#4edea3] hover:text-white text-xs font-bold transition-colors border border-[#4edea3]/30 px-3 py-1.5 rounded-xl hover:bg-[#4edea3]/10"
              >
                Ver Demo
              </Link>
              <Link 
              ...
              {user ? (
                ...
                <>
                  <Link 
                    ...
                    className="cta-gradient text-[#003824] font-extrabold px-8 py-4 rounded-2xl hover:shadow-[0_0_30px_rgba(78,222,163,0.4)] transition-all active:scale-95 text-md flex items-center gap-2 w-full sm:w-auto justify-center"
                  >
                    Probar Demo <ArrowRight className="w-5 h-5" />
                  </Link>
                  <Link 
                    href="/auth/sign-up" 
